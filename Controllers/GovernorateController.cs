...
namespace Gaz_BackEnd.Controllers{
    public class GovernorateController : BaseController{
        ...
        [HttpGet]
        public async Task<ActionResult<Respons<GovernoratesDTO>>>
            GetGovernorates([FromQuery] GovernorateFilter governorateFilter) =>
            Ok(await _GovernoratesServices.GetAll(governorateFilter), governorateFilter.PageNumber);
        ...
        [HttpPost]
        public async Task<ActionResult> AddGovernorates([FromBody] GovernorateForm GovernoratesForm) =>
            Ok(await _GovernoratesServices.add(GovernoratesForm));
